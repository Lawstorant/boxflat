...
class BaseSettings(SettingsPanel):
    ...
    def _set_rotation(self, value: int) -> None:
        self._cm._set_setting("base-limit", value)
        self._cm._set_setting("base-maximum-angle", value)
    ...
    def prepare_ui(self) -> None:
        ...
        self._current_row.subscribe(lambda v: self._cm._set_setting("base-ffb-strength", v))
        ...
        self._current_row.subscribe(lambda v: self._cm._set_setting("main-set-ffb-status", v))
        ...
        self._current_row.subscribe(lambda v: self._cm._set_setting("base-calibration", 1))
        ...
        self._current_row.subscribe(lambda v: self._cm._set_setting("base-road-sensitivity", v))
        ...
        self._current_row.set_expression("*10")
        self._current_row.set_reverse_expression("/10")
        self._current_row.subscribe(lambda v: self._cm._set_setting("base-speed", v))
        ...
        self._current_row.set_expression("*10")
        self._current_row.set_reverse_expression("/10")
        self._current_row.subscribe(lambda v: self._cm._set_setting("base-spring", v))
        ...
        self._current_row.set_expression("*10")
        self._current_row.set_reverse_expression("/10")
        self._current_row.subscribe(lambda v: self._cm._set_setting("base-damper", v))
        ...
        self._current_row.subscribe(lambda v: self._cm._set_setting("base-ffb-reverse", v))
        self._cm.subscribe("base-ffb-reverse", self._current_row.set_value)

        self._add_row(BoxflatSliderRow("Torque output", suffix="%"))
        self._current_row.add_marks(25, 50, 75)
        self._current_row.subscribe(lambda v: self._cm._set_setting("base-torque", v))
        ...
        self._current_row.subscribe(lambda v: self._cm._set_setting("base-natural-inertia-enable", v))
        ...
        self._current_row.subscribe(lambda v: self._cm._set_setting("base-natural-inertia", v))
        ...
        self._current_row.subscribe(lambda v: self._cm._set_setting("base-inertia", v))
        ...
        self._current_row.set_expression("*10")
        self._current_row.set_reverse_expression("/10")
        self._current_row.subscribe(lambda v: self._cm._set_setting("base-friction", v))
        self._cm.subscribe("base-friction", self._current_row.set_value)

        self._add_row(BoxflatSliderRow("Speed-depended Damping", suffix="%"))
        self._current_row.add_marks(50)
        self._current_row.subscribe(lambda v: self._cm._set_setting("base-speed-damping", v))
        ...
        self._current_row.subscribe(lambda v: self._cm._set_setting("base-speed-damping-point", v))
        ...
        self._current_row.subscribe(lambda v: self._cm._set_setting("main-set-led-status", v))
        ...
        self._current_row.subscribe(lambda v: self._cm._set_setting("base-soft-limit-stiffness", v))
        ...
        self._current_row.subscribe(lambda v: self._cm._set_setting("base-soft-limit-strength", v))
        ...
        self._current_row.subscribe(lambda v: self._cm._set_setting("base-soft-limit-retain", v))
        ...
        self._current_row.subscribe(lambda v: self._cm._set_setting("base-temp-strategy", v))
    ...
    def __prepare_eq(self) -> None:
        ...
        for i in range(6):
            self._eq_row.subscribe_slider(i, lambda i,v: self._cm._set_setting(f"base-equalizer{i+1}", v))
    ...
    def _set_curve_point(self, index: int, value: int) -> None:
        self._cm._set_setting(f"base-ffb-curve-y{index+1}", value)
    ...
    def _set_curve(self, values: list) -> None:
        ...
        for i in range(1,5):
            self._cm._set_setting(f"base-ffb-curve-x{i}", curve[i-1])

        for i in range(0,5):
            self._cm._set_setting(f"base-ffb-curve-y{i+1}", curve[i+4])
