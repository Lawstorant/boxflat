...
parser.add_argument("--resizable", help="Make main window resizable", action="store_true", required=False)
...
app = app.MyApp(data_path, args.dry_run, args.resizable, application_id="com.lawstorant.boxflat")
app.run()
